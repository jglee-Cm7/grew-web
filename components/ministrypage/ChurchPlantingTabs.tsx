  ...
  const frontOfficeContent = (
    <div className="space-y-0">
      <FeatureSection
        ...
        labelText="하나"
        imageUrl="/ministry-page/front-1.png"
        imageAlt="개척자 선발 이미지"
        imageOnRight={true}
      />
      <FeatureSection
        ...
        labelText="둘"
        imageUrl="/ministry-page/front-2.png"
      ...
      <FeatureSection
        ...
        labelText="셋"
        imageUrl="/ministry-page/front-3.png"
      ...
      <FeatureSection
        ...
        labelText="넷"
        imageUrl="/ministry-page/front-4.png"
  ...
  const backOfficeContent = (
    <div className="space-y-0">
      <FeatureSection
        ...
        labelText="하나"
        imageUrl="/ministry-page/back-1.png"
        imageAlt="관리 및 피드백 이미지"
        imageOnRight={false}
      />
      <FeatureSection
        ...
        labelText="둘"
        imageUrl="/ministry-page/back-2.png"
        imageAlt="프로세스 개선 이미지"
        imageOnRight={true}
      />
      <FeatureSection
        ...
        labelText="셋"
        imageUrl="/ministry-page/back-3.png"
        imageAlt="관리 및 피드백 이미지"
        imageOnRight={false}
      />
    </div>
