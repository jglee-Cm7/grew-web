...
import Icon1 from "../../public/mainpage/img-main-01.svg";
import Icon2 from "../../public/mainpage/img-main-02.svg";
import Icon3 from "../../public/mainpage/img-main-03.svg";
import LogoImageBlack from "../../public/logo/logo-image-black.svg";
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="flex h-full flex-col justify-between rounded-lg bg-gray-50 p-6 py-8 text-center shadow-sm md:py-10 lg:py-14">
            <div className="mb-6 flex justify-center">
              <Image src={Icon1} alt="비전 아이콘" width={120} height={120} />
            </div>
          ...
          <div className="flex h-full flex-col justify-between rounded-lg bg-gray-50 p-6 py-8 text-center shadow-sm md:py-10 lg:py-14">
            <div className="mb-6 flex justify-center">
              <Image src={Icon2} alt="사역 아이콘" width={120} height={120} />
            </div>
          ...
          <div className="flex h-full flex-col justify-between rounded-lg bg-gray-50 p-6 py-8 text-center shadow-sm md:py-10 lg:py-14">
            <div className="mb-6 flex justify-center">
              <Image src={Icon3} alt="소망 아이콘" width={120} height={120} />
            </div>
