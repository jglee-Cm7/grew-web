...
import { AnimatedButton, InfoBox, Tabs } from "@/components/ui";
    ...
    <div>
      <StaggerContainer className="space-y-4" delay={0.2}>
        <StaggerItem>
          <InfoBox
            heading="일시후원"
            mainText="그루가 진행하는 전체 사업 일시 후원하기"
          />
        </StaggerItem>
        <StaggerItem>
          <InfoBox
            heading="정기후원"
            mainText="그루가 진행하는 전체 사업 정기 후원하기"
          />
        </StaggerItem>
        <StaggerItem>
          <InfoBox
        ...
        <StaggerItem>
          <InfoBox
            heading="재산기부"
            mainText="수도권 내외 인큐베이팅 센터 설립을 위해 후원자가 소유하고 있는 재산 일부(토지, 건물 등)를 후원하고, 이를 통해 그루가 선 정한 개척교회는 그 장소에서 초기 사역(최대 3년) 진행"
          />
        </StaggerItem>
        <StaggerItem>
          <InfoBox
            heading="물품후원"
            mainText="개척에 필요한 여러 물품(사무용품, 가구, 차량, 목회도서, 방송기기, 기타 교회에 필요한 물품 등)을 후원"
          />
        </StaggerItem>
      </StaggerContainer>
      ...
      <FadeIn>
        <div className="mt-16 mb-8 flex justify-center">
          <AnimatedButton
            onClick={() =>
              window.open("https://pay.ongi.site/qr/Meyme144EzA1KHdg", "_blank")
            }
          >
            물질 후원하기
          </AnimatedButton>
    ...
    <div>
      <FadeIn direction="left" delay="medium">
        <div className="mb-8 text-center">
          <p className="text-lg">
            그루(Grew)에 소속된 봉사자(최소 1년 이상)로서 필요에 따라 개척교회
            사역에 파견되어 돕습니다.
          </p>
        </div>
      </FadeIn>
      ...
      <StaggerContainer className="space-y-4" delay={0.2}>
        <StaggerItem>
          <InfoBox
            heading="미디어팀"
            mainText="영상기획, 영상 제작, 음향 및 장비 조율, 유튜브 송출 및 홈페이지 관리, 모니터링 등"
          />
        </StaggerItem>
        <StaggerItem>
          <InfoBox
            heading="기술지원팀"
            mainText="개척 교회 홈페이지 제작 (UI/UX 디자이너, 웹 개발), 그루 후원 시스템 개발"
          />
        </StaggerItem>
        <StaggerItem>
          <InfoBox
            heading="찬양팀"
            mainText="싱어, 반주: 피아노, 기타, 드럼, 일렉, 베이스 등"
          />
        </StaggerItem>
        <StaggerItem>
        ...
        <StaggerItem>
          <InfoBox
            heading="기타"
            mainText="무엇이든 도움 수 있는 것이 생기면 돕고 싶음"
          />
        </StaggerItem>
      </StaggerContainer>
      ...
      <FadeIn>
        <div className="mt-16 mb-8 flex justify-center">
          <AnimatedButton
            onClick={() =>
              window.open(
                "https://docs.google.com/forms/d/1WJ3JwxnakQSAF51ZUXE3LYrLADzBVwxRmxSTcAScwuA",
                "_blank",
              )
            }
          >
        ...
        <FadeIn>
          <div className="mx-auto flex flex-col items-center gap-6 py-12 text-center sm:gap-8 sm:py-16 md:py-20">
            <h2 className="text-xl font-semibold sm:text-2xl lg:text-3xl">
              ...
              재정적 지원과 함께 개척자들과 교회를 섬기실 봉사자분들도
              환영합니다.
            </h2>
          </div>
          <div className="flex flex-col items-center gap-10">
            <Image
              src="/give-page/love-hand.svg"
              alt="Give Image"
              width={97}
              height={97}
              className="size-[70px] sm:size-[97px]"
            />
