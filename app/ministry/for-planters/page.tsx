...
const ForPlantersPage = () => {
  return (
    <main>
      <PageHeader backgroundImage="/pageheaders/for-planters-bg.png">
        개척자들을 위해
      </PageHeader>
      ...
      <section>
        <div className="mx-auto max-w-6xl space-y-0">
          <FeatureSection
            ...
            imageUrl="/ministry-page/support-1.png"
            imageAlt="개척맴버 이미지"
            imageOnRight={true}
          />
          <FeatureSection
            ...
            imageUrl="/ministry-page/support-2.png"
          ...
          <FeatureSection
            ...
            imageUrl="/ministry-page/support-3.png"
            imageAlt="개척 지원 이미지"
            imageOnRight={true}
          />
          <FeatureSection
            ...
            imageUrl="/ministry-page/support-4.png"
            imageAlt="그룹 이미지"
            imageOnRight={false}
          />
        </div>
